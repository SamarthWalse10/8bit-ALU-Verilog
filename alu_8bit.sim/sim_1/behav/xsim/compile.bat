...
REM
REM Generated by Vivado on Wed Nov 23 12:16:18 +0530 2022
...
echo "xvlog --incr --relax -prj alu_8bit_tb_vlog.prj"
call xvlog  --incr --relax -prj alu_8bit_tb_vlog.prj -log xvlog.log
